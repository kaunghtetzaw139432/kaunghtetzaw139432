...
I am a passionate **Software Engineering Student** and Backend Developer dedicated to building clean, scalable, and high-performance server-side applications. I specialize in designing secure RESTful APIs and modernizing system architectures using **Java Spring Boot** and **C# .NET Core**.
